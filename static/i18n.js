...
const i18n = {
  ...
  translations: {
    zh: {
      ...
      'terminal.help.context': 'Context 信息',
    ...
    en: {
      ...
      'terminal.help.context': 'Context info',
    ...
    ja: {
      ...
      'terminal.help.context': 'Context情報',
    ...
    ko: {
      ...
      'terminal.help.context': 'Context 정보',
    ...
    fr: {
      ...
      'terminal.help.context': 'Info Context',
    ...
    ru: {
      ...
      'terminal.help.context': 'Инфо Context',
