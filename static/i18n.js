...
const i18n = {
  ...
  translations: {
    zh: {
      ...
      'sessions.help.ctxUsed': '已用 / 最大容量 (百分比)',
      'sessions.help.ctxFree': '剩余可用空间',
      'sessions.help.ctxCompact': '距离自动压缩',
      'sessions.help.ctxTotal': '会话总消耗 tokens',
      'sessions.help.tipContext': '运行 /context 后显示详细信息',
      ...
      'terminal.help.stop': '停止当前操作',
      'terminal.help.complete': '自动补全',
      'terminal.help.send': '发送/确认',
      'terminal.help.tip': '点击 ⋯ 展开组合键和斜杠命令',
      'terminal.help.toolbarTitle': '工具栏',
      'terminal.help.back': '关闭终端，返回列表',
      'terminal.help.minimizeDesc': '收起到后台运行',
    ...
    en: {
      ...
      'sessions.help.ctxUsed': 'Used / Max capacity (percent)',
      'sessions.help.ctxFree': 'Free space remaining',
      'sessions.help.ctxCompact': 'Until auto-compact',
      'sessions.help.ctxTotal': 'Total session tokens',
      'sessions.help.tipContext': 'Run /context for detailed info',
      ...
      'terminal.help.stop': 'Stop current action',
      ...
      'terminal.help.toolbarTitle': 'Toolbar',
      'terminal.help.back': 'Close terminal, back to list',
      'terminal.help.minimizeDesc': 'Minimize to background',
    ...
    ja: {
      ...
      'sessions.help.contextTitle': 'Context アイコン説明',
      'sessions.help.ctxUsed': '使用量 / 最大容量 (パーセント)',
      'sessions.help.ctxFree': '残り空き容量',
      'sessions.help.ctxCompact': '自動圧縮まで',
      'sessions.help.ctxTotal': 'セッション合計トークン',
      'sessions.help.tipContext': '/context で詳細表示',
      ...
      'terminal.help.stop': '操作を停止',
      'terminal.help.complete': '自動補完',
      'terminal.help.send': '送信/確認',
      'terminal.help.tip': '⋯をクリックで詳細表示',
      'terminal.help.toolbarTitle': 'ツールバー',
      'terminal.help.back': '終了してリストに戻る',
      'terminal.help.minimizeDesc': 'バックグラウンドに最小化',
    ...
    ko: {
      ...
      'sessions.help.contextTitle': 'Context 아이콘 설명',
      'sessions.help.ctxUsed': '사용량 / 최대 용량 (퍼센트)',
      'sessions.help.ctxFree': '남은 공간',
      'sessions.help.ctxCompact': '자동 압축까지',
      'sessions.help.ctxTotal': '세션 총 토큰',
      'sessions.help.tipContext': '/context 로 상세 정보 보기',
      ...
      'terminal.help.stop': '현재 작업 중지',
      'terminal.help.complete': '자동 완성',
      'terminal.help.send': '전송/확인',
      'terminal.help.tip': '⋯를 클릭하여 더 보기',
      'terminal.help.toolbarTitle': '도구 모음',
      'terminal.help.back': '터미널 닫고 목록으로',
      'terminal.help.minimizeDesc': '백그라운드로 최소화',
    ...
    fr: {
      ...
      'sessions.help.ctxUsed': 'Utilisé / Capacité max (pourcent)',
      'sessions.help.ctxFree': 'Espace libre restant',
      'sessions.help.ctxCompact': 'Avant auto-compactage',
      'sessions.help.ctxTotal': 'Tokens totaux de session',
      'sessions.help.tipContext': 'Exécutez /context pour les détails',
      ...
      'terminal.help.stop': 'Arrêter l\'action',
      'terminal.help.complete': 'Auto-complétion',
      'terminal.help.send': 'Envoyer/Confirmer',
      'terminal.help.tip': 'Cliquez sur ⋯ pour plus',
      'terminal.help.toolbarTitle': 'Barre d\'outils',
      'terminal.help.back': 'Fermer et retour à la liste',
      'terminal.help.minimizeDesc': 'Réduire en arrière-plan',
    ...
    de: {
      ...
      'sessions.help.ctxUsed': 'Verwendet / Max (Prozent)',
      'sessions.help.ctxFree': 'Freier Speicher',
      'sessions.help.ctxCompact': 'Bis Auto-Kompakt',
      'sessions.help.ctxTotal': 'Gesamt-Token der Sitzung',
      'sessions.help.tipContext': '/context für Details ausführen',
      ...
      'terminal.help.stop': 'Aktion stoppen',
      ...
      'terminal.help.toolbarTitle': 'Werkzeugleiste',
      'terminal.help.back': 'Schließen und zur Liste',
      'terminal.help.minimizeDesc': 'Im Hintergrund minimieren',
    ...
    es: {
      ...
      'sessions.help.contextTitle': 'Iconos de Context',
      'sessions.help.ctxUsed': 'Usado / Máximo (porcentaje)',
      'sessions.help.ctxFree': 'Espacio libre restante',
      'sessions.help.ctxCompact': 'Hasta auto-compactación',
      'sessions.help.ctxTotal': 'Tokens totales de sesión',
      'sessions.help.tipContext': 'Ejecuta /context para detalles',
      ...
      'terminal.help.stop': 'Detener acción',
      'terminal.help.complete': 'Autocompletar',
      'terminal.help.send': 'Enviar/Confirmar',
      'terminal.help.tip': 'Clic en ⋯ para más',
      'terminal.help.toolbarTitle': 'Barra de herramientas',
      'terminal.help.back': 'Cerrar y volver a la lista',
      'terminal.help.minimizeDesc': 'Minimizar en segundo plano',
    ...
    ru: {
      ...
      'sessions.help.ctxUsed': 'Использовано / Макс (процент)',
      'sessions.help.ctxFree': 'Свободное место',
      'sessions.help.ctxCompact': 'До авто-сжатия',
      'sessions.help.ctxTotal': 'Всего токенов сессии',
      'sessions.help.tipContext': 'Запустите /context для деталей',
      ...
      'terminal.help.stop': 'Остановить действие',
      'terminal.help.complete': 'Автодополнение',
      'terminal.help.send': 'Отправить/Подтвердить',
      'terminal.help.tip': 'Нажмите ⋯ для большего',
      'terminal.help.toolbarTitle': 'Панель инструментов',
      'terminal.help.back': 'Закрыть и вернуться к списку',
      'terminal.help.minimizeDesc': 'Свернуть в фон',
    ...
    pt: {
      ...
      'sessions.help.contextTitle': 'Ícones de Context',
      'sessions.help.ctxUsed': 'Usado / Máximo (porcentagem)',
      'sessions.help.ctxFree': 'Espaço livre restante',
      'sessions.help.ctxCompact': 'Até auto-compactação',
      'sessions.help.ctxTotal': 'Tokens totais da sessão',
      'sessions.help.tipContext': 'Execute /context para detalhes',
      ...
      'terminal.help.stop': 'Parar ação',
      'terminal.help.complete': 'Auto completar',
      'terminal.help.send': 'Enviar/Confirmar',
      'terminal.help.tip': 'Clique em ⋯ para mais',
      'terminal.help.toolbarTitle': 'Barra de ferramentas',
      'terminal.help.back': 'Fechar e voltar à lista',
      'terminal.help.minimizeDesc': 'Minimizar em segundo plano',
