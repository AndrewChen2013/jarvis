...
const i18n = {
  ...
  translations: {
    zh: {
      ...
      'sessions.help.longPress': '长按',
      'sessions.help.longPressDesc': '重命名 / 删除会话',
    ...
    en: {
      ...
      'sessions.help.longPress': 'Long press',
      'sessions.help.longPressDesc': 'Rename / Delete session',
    ...
    ja: {
      ...
      'sessions.help.longPress': '長押し',
      'sessions.help.longPressDesc': '名前変更 / 削除',
    ...
    ko: {
      ...
      'sessions.help.longPress': '길게 누르기',
      'sessions.help.longPressDesc': '이름 변경 / 삭제',
    ...
    fr: {
      ...
      'sessions.help.longPress': 'Appui long',
      'sessions.help.longPressDesc': 'Renommer / Supprimer',
    ...
    de: {
      ...
      'sessions.help.longPress': 'Lang drücken',
      'sessions.help.longPressDesc': 'Umbenennen / Löschen',
    ...
    es: {
      ...
      'sessions.help.longPress': 'Mantener presionado',
      'sessions.help.longPressDesc': 'Renombrar / Eliminar',
    ...
    ru: {
      ...
      'sessions.help.longPress': 'Долгое нажатие',
      'sessions.help.longPressDesc': 'Переименовать / Удалить',
    ...
    pt: {
      ...
      'sessions.help.longPress': 'Pressionar longo',
      'sessions.help.longPressDesc': 'Renomear / Excluir',
